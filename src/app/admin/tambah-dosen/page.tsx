...
export default function TambahDosenPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    const result = await addDosen(formData)
  ...
  return (
    <div className="max-w-3xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Tambah Akun Dosen</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">NIP / NIDN</label>
              <input
                name="nip"
                type="text"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Jurusan / Homebase</label>
              <select
                name="prodi"
                required
          ...
          {credentials ? (
            <div className="bg-green-50 rounded-lg border border-green-200 p-6">
              ...
              <p className="text-xs text-green-700 mt-3 text-center">
                Silakan salin dan berikan informasi login ini kepada dosen yang bersangkutan. Dosen akan diminta mengganti password saat login pertama kali.
              </p>
            </div>
          ) : (
