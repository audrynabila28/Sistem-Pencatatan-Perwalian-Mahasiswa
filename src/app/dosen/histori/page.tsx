...
export default async function HistoriDosenPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <h2 className="text-2xl font-bold text-gray-900 mb-6">Histori Perwalian Mahasiswa Wali</h2>
      <p className="mb-4 text-gray-600">Berikut adalah daftar riwayat perwalian dari mahasiswa bimbingan Anda.</p>
